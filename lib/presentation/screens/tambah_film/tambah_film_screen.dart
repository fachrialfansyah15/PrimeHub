        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 14),
              _buildField(controller: _posterCtrl, label: 'URL Gambar Poster', hint: 'https://example.com/poster.jpg', icon: Icons.image, keyboardType: TextInputType.url),
              const SizedBox(height: 14),
              _buildField(controller: _sampulCtrl, label: 'URL Gambar Sampul', hint: 'https://example.com/cover.jpg', icon: Icons.panorama, keyboardType: TextInputType.url, isRequired: false),
              const SizedBox(height: 14),
              _buildField(
                controller: _tahunCtrl, label: 'Tahun Rilis', hint: 'Contoh: 2024',
                icon: Icons.calendar_today, keyboardType: TextInputType.number,
                validator: (val) {
                  if (val == null || val.trim().isEmpty) return 'Tahun rilis tidak boleh kosong';
              ...
              _buildField(
                ...
                validator: (val) {
                  if (val == null || val.trim().isEmpty) return 'Rating tidak boleh kosong';
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(_isLoading ? 'Menyimpan...' : 'Simpan Film',
